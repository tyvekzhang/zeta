...
# 设置标题
plt.title('2015—2024年贵州茅台利润表关键指标趋势图', fontsize=16)
...
ax1.set_xticklabels(years, fontsize=10) # 倾斜45度，更易读
...
# --- 核心修改 2: 调整图例位置 (bbox_to_anchor Y值从-0.2改为-0.1) ---
ax1.legend(
    handles=legend_handles, 
    labels=legend_labels, 
    loc='upper center', 
    bbox_to_anchor=(0.5, -0.1), # Y值改为-0.1，向上移动
...
# 调整布局以容纳位于下方的图例
plt.tight_layout(rect=[0, 0.05, 1, 1]) # rect Y轴最小值也稍微调高到0.05
plt.show()